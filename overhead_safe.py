                        ...
                        data.append(
                            {
                                ...
                                "callsign": callsign,
                                "ground_speed": ground_speed  # Adding ground speed to the data dictionary

                            }
                        )

                        #print(f"Plane: {plane}, Origin: {origin}, Destination: {destination}, Altitude: {flight.altitude}, Vertical Speed: {flight.vertical_speed}, Callsign: {callsign}")
