...
TEMPERATURE_FONT = fonts.small  # Updated to a bigger font
TEMPERATURE_FONT_HEIGHT = 6  # Adjusted height for medium font
TEMPERATURE_POSITION = (48, TEMPERATURE_FONT_HEIGHT + 1)  # Adjusted position

TEMPERATURE_COLOURS = (
    (32, colours.WHITE),   # 32°F and below - White
    (34, colours.BLUE_LIGHT),  # Above 34°F - Light Blue
    (46, colours.PINK_DARK),   # Above 46°F - Dark Pink
    (64, colours.YELLOW),     # Above 64°F - Yellow
    (86, colours.ORANGE),     # Above 86°F - Orange
)
...
def grab_current_temperature(location, units="metric"):
    ...
    try:
        ...
        current_temp = weather["temp_c"]  # Assuming weather data in Celsius

    except:
        pass

    if units == "imperial":
        current_temp = (current_temp * 9/5) + 32  # Convert C to F
